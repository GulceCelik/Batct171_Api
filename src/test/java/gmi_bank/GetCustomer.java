...
public class GetCustomer extends GmiBankBaseUrl {
    ...
    public void name() {
        ...
        List<AccountsPojo> accountsList = Arrays.asList(account1,account2);
        CustomerPojo expectedData = new CustomerPojo(133986,"Danika", "Huel","S","danikahuel@gmail.com","155-489-7844","155-489-7844","32476","3848 Lang Hill","Free City","725-97-6213","2022-01-21T05:00:00Z", false,country ,"Apple",user,accountsList);
      Response response = given(spec).when().get("{first}/{second}/{third}");
      response.prettyPrint();
      CustomerPojo actualData = response.as(CustomerPojo.class);

      //Assertion kismi ODEV
