...
/*
    ...
    public void get03HardAssertion() {
        ...
        // 2- Set the expected data (Bu islemi POST PUY gibi methodlarda
        // kullanacagimiz zaman GET methodu ile kullandigimizda datalari karsilikli
        //dogrulayacagimiz zaman yapacagiz)
        // 3. Send the request and get the response
        given()
                .when()
                .get()
